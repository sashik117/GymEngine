...
const _exercisePhrases = [
  ...
  _ExercisePhrase([
    ...
    'good',
    'morning',
  ], 'нахили зі штангою на прямих ногах'),
  _ExercisePhrase(['band', 'good', 'morning'], 'нахили з резинкою'),
  _ExercisePhrase(['barbell', 'good', 'morning'], 'нахили зі штангою'),
  _ExercisePhrase(['seated', 'good', 'morning'], 'нахили сидячи'),
  _ExercisePhrase(['smith', 'good', 'morning'], 'нахили у Сміті'),
  _ExercisePhrase(['pvc', 'good', 'morning'], 'нахили з PVC-палицею'),
  _ExercisePhrase(['good', 'morning', 'squat'], 'присідання з нахилом корпусу'),
...
const _tokenTranslations = {
  ...
  'pvc': 'PVC-палиця',
  'stick': 'палиця',
  'gastrocnemius': 'литковий мʼяз',
  'soleus': 'камбалоподібний мʼяз',
  'tibia': 'великогомілковий мʼяз',
  'press': 'жим',
  'squat': 'присідання',
  'lunge': 'випад',
  'row': 'тяга',
